# Mini Project B — Secure Flask Portfolio & Guestbook
...
os.environ["LINKEDIN_URL"] = "https://www.linkedin.com/in/your-profile/"
```
...
4. In the Web tab, set **Virtualenv** to `/home/YOUR-USERNAME/flask-portfolio/.venv`.
5. Open the WSGI configuration file and replace its Flask section with:
   ...
   project_home = "/home/YOUR-USERNAME/flask-portfolio"
   if project_home not in sys.path:
       sys.path.insert(0, project_home)

   os.environ["SECRET_KEY"] = "replace-this-with-a-long-random-value"
   os.environ["SITE_OWNER"] = "Your Name"
   os.environ["LINKEDIN_URL"] = "https://www.linkedin.com/in/your-profile/"
...
6. In the Web tab, add this static-files mapping:
   - URL: `/static/`
   - Directory: `/home/YOUR-USERNAME/flask-portfolio/static/`
7. Click **Reload**, then open the website link shown at the top of the Web tab.

No MySQL account is required. The app uses SQLite and creates the database at `/home/YOUR-USERNAME/flask-portfolio/instance/comments.db`. Choose a long, random `SECRET_KEY`; changing it later will sign out existing sessions.
